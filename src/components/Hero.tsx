...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative overflow-hidden bg-slate-950 pb-6 pt-5 text-white sm:pb-12 sm:pt-10 lg:pb-16 lg:pt-16"
    >
      {/* tło dekoracyjne */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-5 lg:px-8">
        <div className="grid items-center gap-4 sm:gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="text-center lg:col-start-1 lg:row-start-1 lg:text-left">
            {/* Badge dostępności */}
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-emerald-500/15 border border-emerald-500/30 px-3 py-1 text-xs font-semibold text-emerald-300 sm:mb-6 sm:px-4 sm:py-1.5 sm:text-sm lg:mx-0">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-sm leading-relaxed text-white/70 sm:mt-4 sm:text-base lg:mx-0 lg:text-lg">
                ...
                >
                  ...
                  <div className="grid gap-3">
                    ...
                    <button
                      ...
                      className="w-full whitespace-nowrap rounded-full bg-gradient-to-r from-sky-400 to-cyan-400 px-5 py-3 text-base font-bold text-slate-950 shadow-lg transition hover:brightness-110 disabled:opacity-60"
                    >
          ...
          <div className="text-center lg:col-start-1 lg:row-start-2 lg:text-left">
            ...
            <div className="flex flex-col justify-center gap-2 sm:flex-row sm:flex-wrap sm:gap-3 lg:justify-start">
              <a
                href="https://czasklimy.pl/#/modele"
                className="inline-flex items-center justify-center gap-1.5 rounded-full border border-sky-400/50 bg-sky-400/10 px-5 py-2.5 text-sm font-semibold text-sky-300 transition hover:bg-sky-400/20 hover:text-sky-200 sm:px-6 sm:py-3"
              >
                Klimatyzacja z montażem → ceny
              </a>
              <a
                href="tel:+48788304845"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/10 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-white/15 sm:px-6 sm:py-3 sm:text-base"
              >
